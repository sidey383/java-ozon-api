...
@Getter
public class ClientStatisticExpenseRequest extends ClientStatisticRequest {
    ...
    public ClientStatisticExpenseRequest(@NotNull Long[] campaignIds, @NotNull LocalDate from, @NotNull LocalDate to) {
