...
@Getter
public class ClientStatisticProductRequest extends ClientStatisticRequest {
    ...
    public ClientStatisticProductRequest(@NotNull Long[] campaignIds, @NotNull LocalDate from, @NotNull LocalDate to) {
    ...
    public ClientStatisticProductRequest(@NotNull Long[] campaignIds, @NotNull Instant from, @NotNull Instant to) {
        this.campaignIds = campaignIds;
        this.dateFrom = null;
        this.dateTo = null;
        this.from = from;
